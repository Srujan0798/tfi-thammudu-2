        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Sign in to sync your TFI timeline</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-slate-900 text-gray-500">Or continue with email</span>
                        </div>
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                        <div>
                            <input
                                ...
                                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-yellow-400 transition-colors"
                            />
                        </div>
                        <div>
                            <input
                        ...
                        <button
                            className="w-full px-6 py-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-bold rounded-xl hover:scale-[1.02] transition-transform"
                        >
                            Sign In
                        </button>
                    </form>
